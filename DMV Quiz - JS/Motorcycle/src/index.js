...
const languageString = {
  'en': {
    'translation': {
      'QUETIONS': questions['QUESTIONS_EN_US'],
      'GAME_NAME': 'Practice Permit', // Be sure to change this for your skill.
      ...
      'GAME_OVER_MESSAGE': 'You got %s out of %s questions correct. If you would like to keep playing, say, start new game. If not, say, cancel',
  ...
  'sp': {
    'translation': {
      'QUESTIONS': questions['QUESTIONS_SP_SP'],
      'GAME_NAME': 'Permiso de práctica', // Be sure to change this for your skill.
      'HELP_MESSAGE': 'Te preguntare %s preguntas de respuestas múltiples. Responda con el número de la respuesta. ' + 'Por ejemplo, digamos uno, dos, tres o cuatro. Para comenzar un nuevo juego en cualquier momento, diga comenzar el juego. ',
      'REPEAT_QUESTION_MESSAGE': 'Para repetir la última pregunta, repita. ',
      'ASK_MESSAGE_START': '¿Te gustaría empezar a jugar?',
      'HELP_REPROMPT': 'Dar una respuesta a una pregunta, respuesta con el número de la respuesta. ',
      'STOP_MESSAGE': '¿Te gustaría seguir jugando?',
      'CANCEL_MESSAGE': 'Ok, vamos a jugar de nuevo pronto.',
      'NO_MESSAGE': 'Ok, jugaremos otra vez. ¡Adiós!',
      'TRIVIA_UNHANDLED': 'Intente decir un número entre 1 y %s',
      'HELP_UNHANDLED': 'Diga sí para continuar, o no para terminar el juego.',
      'START_UNHANDLED': 'Diga empezar a comenzar un nuevo juego.',
      'NEW_GAME_MESSAGE': 'Bienvenido a %s. ',
      'WELCOME_MESSAGE': 'Te preguntare %s preguntas, trate de obtener el mayor número posible. ' + 'Sólo diga el número de la respuesta. Vamos a empezar. ',
      'ANSWER_CORRECT_MESSAGE': 'correcto. ',
      'ANSWER_WRONG_MESSAGE': 'incorrecto. ',
      'CORRECT_ANSWER_MESSAGE': 'La respuesta correcta es %s: %s. ',
      'ANSWER_IS_MESSAGE': 'Esa respuesta es ',
      'TELL_QUESTION_MESSAGE': 'Pregunta %s. %s ',
      'GAME_OVER_MESSAGE': 'Tu tienes %s fuera de %s pregunta correcta ¡Gracias por jugar!',
      'SCORE_IS_MESSAGE': 'Tu puntaje es %s. ',
    },
  },
};
...
const newSessionHandlers = {
  ...
  'AMAZON.StartOverIntent': function () {
    this.handler.state = GAMES_STATES.START;
    this.emitWithState('StartGame', true);
  },
